...
### [Phase 1: CLI Foundation & Core Engine](CLI_Foundation.md)
...
### [Phase 2: TCP Client-Server Architecture](TCP_Storage_Server.md)
...
### [Phase 3: Node.js Web API layer](NodeJS_Web_API.md)
...
### [Phase 4: React Full-Stack UI](React_Full_Stack.md)
