...
class UserClientCommTest : public ::testing::Test {
protected:
    UserClientComm* comm;
    ...
    // ============================================================
    // HELPER: Test that input produces expected command string
    // ============================================================
