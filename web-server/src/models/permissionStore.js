...
const permissionStore = {
    async create(pid, fileId, userId, level, isInherited = false, inheritedFrom = null) {
        ...
        const newPermission = new Permission(pid, fileId, userId, level, isInherited, inheritedFrom);
