...
public:
    ...
    bool exists(const std::string& clientId, const std::string& fileName) override {
        existsCalled = true;
    ...
    void create(const std::string& clientId, const std::string& fileName, const std::string& content = "") override {
        createCalled = true;
        postCalled = true;
        lastClientId = clientId;
        lastFileName = fileName;
    ...
    void write(const std::string& clientId, const std::string& fileName, const std::string& content) override {
        // Same as create for mock purposes
        create(clientId, fileName, content);
    }

    std::string read(const std::string& clientId, const std::string& fileName) override {
        readCalled = true;
        lastClientId = clientId;
        lastFileName = fileName;
    ...
    std::vector<std::string> search(const std::string& clientId, const std::string& term) override {
        searchCalled = true;
        lastClientId = clientId;
        lastSearch = term;
    ...
    void remove(const std::string& clientId, const std::string& fileName) override {
        deleteCalled = true;
        removeCalled = true;
        lastClientId = clientId;
        lastFileName = fileName;
    ...
    std::vector<std::string> list(const std::string& clientId) override {
